...
if __name__ == "__main__":
    ...
    # Save profile data to .prof file
    cProfile.run('main()', filename='snakeviz_profile.prof')

    print("✅ Run complete. Use `snakeviz snakeviz_profile.prof` to view the profile.")
